/**
 * Extract real heritage figures from HTML files
 */
...
const outputPath = path.join(rootDir, 'data', 'heritage-figures.json');
fs.writeFileSync(outputPath, JSON.stringify(output, null, 2));

console.log(`\n✅ Extracted ${heritageFigures.length} heritage figures`);
