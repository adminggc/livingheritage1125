/**
 * Extract real wellness tips from HTML files
 */

const fs = require('fs');
const path = require('path');

// Files that contain wellness tips
const tipFiles = [
...
const outputPath = path.join(rootDir, 'data', 'wellness-tips.json');
fs.writeFileSync(outputPath, JSON.stringify(output, null, 2));

console.log(`\n✅ Extracted ${wellnessTips.length} wellness tips`);
