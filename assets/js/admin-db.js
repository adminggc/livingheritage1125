...
class LivingHeritageAdminDB {
  ...
  async saveProfile(e) {
    ...
    const profileData = {
      ...
      url_slug: (document.getElementById(nameId).value || '').toLowerCase().replace(/\s+/g, '-') + '.html',
  ...
  async saveNews(e) {
    ...
    const newsData = {
      ...
      language: language,
      published: document.getElementById(publishedId).checked,
      slug: (document.getElementById(titleId).value || '').toLowerCase().replace(/\s+/g, '-'),
  ...
  async saveTip(e) {
    ...
    const tipData = {
      ...
      language: language,
      published: document.getElementById(publishedId).checked,
      url_slug: (document.getElementById(titleId).value || '').toLowerCase().replace(/\s+/g, '-') + '.html'
    };
