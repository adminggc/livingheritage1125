/**
 * Extract podcast data from English podcast.html
 */
...
console.log(`Found ${videoIds.length} English podcast video IDs\n`);
...
console.log(`Found ${titles.length} English podcast titles\n`);
...
const outputPath = path.join(__dirname, 'data', 'podcasts-en.json');
fs.writeFileSync(outputPath, JSON.stringify(output, null, 2));

console.log(`\n✅ Extracted ${podcasts.length} English podcasts`);
console.log(`📁 Saved to: data/podcasts-en.json`);
